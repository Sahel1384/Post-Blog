      ...
      <div class="dropdowns d-flex justify-content-between mb-3">
        ...
        <div id="filter">
          ...
          <div class="filter-menu">
            <a href="{{ route('allCateAuth') }}" class="">All</a>
            <a href="{{ route('computerCateSingle') }}" class="">Computer</a>
            <a href="{{ route('mobileCateSingle') }}" class="">Mobile</a>
            <a href="{{ route('sportCateSingle') }}" class="">Sport</a>
          </div>
          </div>
      </div>
            ...
            <div class="col-md-4">
                <div class="cards">
                  ...
                  <div id="card-icon" class="mt-1">
                    ...
                    <div>
                      <a href="{{ route('comment', $post->id) }}" class="text-dark"><i class="bi bi-share {{ $post->comments()->where('user_id',Auth::id())->exists() ? 'text-primary' : "text-dark" }}"></i></a>
                      <p>{{ $post->comments_count }}</p>
                    </div>
                    <div>
